...
//     // how to setup event delegation?
//     $(document).click("??", "??", function () {
//         //get some custom attribute? or value?
//         //make a ajax call?
//         //on the result of the ajax, add a gif to the screen?
//     })
//     $("#add-rapper").click(function (e) {     //e -> event, always use it
//         e.preventDefault();
//         //create a new button for the onclick
//         var name = $("#rapper-name").val().trim();

//         if (name !== "") {
//             $("#buttons").append(`<button class="rapper-btn btn>${name}</button>`)
//             $("rapper-name").val("");
//         }
//     });
...
function getTopicImages() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=" + api_key + "&q=" + topic + "YQaJ38AcYKNHMLnV3FlW0DaSDiv5yHOL";
